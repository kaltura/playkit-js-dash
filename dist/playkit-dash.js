...
var DashAdapter = function (_BaseMediaSourceAdapt) {
  ...
  function DashAdapter(videoElement, source) {
    ...
    }), _defineProperty(_this$_adapterEventsB, _playkitJs.BaseMediaSourceAdapter.Html5Events.WAITING, function () {
      return _this._onWaiting();
    }), _defineProperty(_this$_adapterEventsB, _playkitJs.BaseMediaSourceAdapter.Html5Events.PLAYING, function () {
  ...
  _createClass(DashAdapter, [{
    ...
    value: function _addBindings() {
      ...
      this._videoElement.addEventListener(_playkitJs.BaseMediaSourceAdapter.Html5Events.WAITING, this._adapterEventsBindings.waiting);
      this._videoElement.addEventListener(_playkitJs.BaseMediaSourceAdapter.Html5Events.PLAYING, this._adapterEventsBindings.playing);
    }
    ...
    value: function _removeBindings() {
      ...
      this._videoElement.removeEventListener(_playkitJs.BaseMediaSourceAdapter.Html5Events.WAITING, this._adapterEventsBindings.waiting);
      this._videoElement.removeEventListener(_playkitJs.BaseMediaSourceAdapter.Html5Events.PLAYING, this._adapterEventsBindings.playing);
    }
    ...
    value: function _onError(event) {
      if (event && event.detail) {
        ...
        this._trigger(_playkitJs.BaseMediaSourceAdapter.Html5Events.ERROR, new _playkitJs.Error(error.severity, error.category, error.code, error.data));
